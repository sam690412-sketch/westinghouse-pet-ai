...
export const PRODUCTS: ProductData[] = [
  {
    ...
    image: "/images/products/card/m81-card.webp",
    badge: "旗艦新品",
    features: ["4°C+鎖鮮保存","25°C+預熱出糧","300°旋轉攝影機","2.4G/5G雙頻WiFi","語音對講移動監測"],
  },
  {
    ...
    image: "/images/products/card/m12-card.webp",
    badge: "熱銷",
    features: ["全景攝影機免費回放","24小時動態跟蹤","4L大容量多重鎖鮮","防卡糧軟膠齒輪","電源電池雙供電"],
  },
  {
    ...
    image: "/images/products/card/m31-card.webp",
    features: ["扭蛋機外觀3L容量","各種乾糧適配不卡糧","密閉鎖鮮只出不進","全卡扣設計3秒速拆","電源電池雙供電"],
  },
  {
    ...
    image: "/images/products/card/d11-ba-card.webp",
    badge: "熱銷冠軍",
    features: ["寵物喝水量監控","缺水簡訊提醒","四重過濾","2.5L大容量","清洗換芯提醒"],
  },
  {
    ...
    image: "/images/products/card/d61-card.webp",
    features: ["食品級304不鏽鋼","4L超大容量","47天長續航","3重安全設計防乾燒","靜音活水多重過濾"],
  },
];
