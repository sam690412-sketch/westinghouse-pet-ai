...
export const REVIEWS: Review[] = [
  {
    ...
    scenario: "單貓家庭，上班族",
    images: 3,
    photos: ["/images/reviews/review-m81-01.jpg", "/images/reviews/review-m81-02.jpg", "/images/reviews/review-m81-03.jpg"],
    likes: 42,
    verified: true,
    badge: "購買已驗證",
    highlight: "貓咪愛上喝水",
  ...
  },
  {
    ...
    scenario: "多貓家庭（3隻）",
    images: 2,
    photos: ["/images/reviews/review-d61-01.jpg", "/images/reviews/review-d61-02.jpg"],
    likes: 38,
    verified: true,
    badge: "多貓家庭推薦",
    highlight: "安裝超簡單",
  ...
  },
  {
    ...
    scenario: "租屋族，單貓",
    images: 2,
    photos: ["/images/reviews/review-m12-01.jpg", "/images/reviews/review-m12-02.jpg"],
    likes: 56,
    verified: true,
    badge: "上班族必備",
    highlight: "租屋族救星",
  ...
  },
  {
    ...
    scenario: "單貓家庭，設計師",
    images: 4,
    photos: ["/images/reviews/review-m31-01.jpg", "/images/reviews/review-m31-02.jpg", "/images/reviews/review-m31-03.jpg"],
    likes: 71,
    verified: true,
    badge: "顏值擔當",
    highlight: "扭蛋造型超療癒",
  ...
  },
  {
    ...
    scenario: "經常出差，單貓",
    images: 2,
    photos: ["/images/reviews/review-m81-04.jpg", "/images/reviews/review-m81-05.jpg"],
    likes: 45,
    verified: true,
    badge: "出差族推薦",
    highlight: "一週出差也不怕",
